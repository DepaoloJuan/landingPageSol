...
const images = [
  ...
  "https://images.unsplash.com/photo-1596755389378-c11dde124153?auto=format&fit=crop&q=80",
  "https://images.unsplash.com/photo-1600185960012-dbd486888ac8?auto=format&fit=crop&q=80",
  "https://images.unsplash.com/photo-1512496015851-a1fbbfc69229?auto=format&fit=crop&q=80",
    ...
    <section id="gallery" className="py-24 md:py-36 bg-cream">
      <Container>
        <div className="text-center mb-16 md:mb-24">
          ...
          >
            Una muestra de nuestro arte, precisión y dedicación en cada detalle.
          </motion.p>
        </div>
