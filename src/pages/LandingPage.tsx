...
export function LandingPage() {
  ...
  return (
    <>
      ...
      <div className={`bg-beige-light font-sans text-charcoal selection:bg-gold/30 selection:text-white transition-opacity duration-300 ${showIntro ? 'opacity-0' : 'opacity-100'}`}>
        <Header />
        <main>
          <Hero />
          <About />
